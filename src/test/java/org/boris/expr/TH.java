...
public class TH extends TestCase
{
    ...
    public static Object eval(IExprFunction function, Object... args)
        ...
        return Exprs.convertExpr(context, function.evaluate(context, Exprs
                .convertArgs(args)));
    }

    public static Object eval(IEvaluationContext context,
            IExprFunction function, Object... args) throws ExprException {
        return Exprs.convertExpr(context, function.evaluate(context, Exprs
                .convertArgs(args)));
    }
    ...
    public static void assertException(IExprFunction function, Object... args) {
        try {
            function.evaluate(null, Exprs.convertArgs(args));
    ...
    public static void assertEquals(Expr e, Object o) throws ExprException {
        assertEquals(Exprs.convertExpr(new BasicEvaluationCallback(), e), o);
    }
    ...
    public static ExprVariable var(String var) throws ExprException {
        ...
        if (r != null)
            var = r.toString();
        ExprVariable v = new ExprVariable(var);
        v.setAnnotation(r);
        return v;
    }
